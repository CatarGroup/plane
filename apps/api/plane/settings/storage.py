    ...
    def __init__(self, request=None):
        ...
        if os.environ.get("USE_MINIO") == "1":
            ...
            self.s3_client = boto3.client(
                ...
                endpoint_url=(
                    os.environ.get("LOCAL_DEV_DIRECT_MINIO_URL")
                    if os.environ.get("LOCAL_DEV_DIRECT_MINIO_URL")
                    else (f"{endpoint_protocol}://{request.get_host()}" if request else self.aws_s3_endpoint_url)
                ),
